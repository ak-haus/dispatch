...
omitted:
  ...
  - section: "Shapes"
    reason: "no ratified radius scale exists in canon (see Open questions, OQ-4 adjacency)"
colors:
  # platform tier
...
| body | `'Inter', system-ui, -apple-system, sans-serif` | `tokens.theme.css` (`@theme`) | dispatch |
