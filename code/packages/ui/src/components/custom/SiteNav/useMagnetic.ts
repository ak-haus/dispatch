 ...
 *
 * Moved into the library at B16 (SiteNav fork retirement, 2026-08-31) from
 * the microsite's src/lib/useMagnetic.ts, verbatim: SiteNav's
 * MagneticNavLink consumes it here, and the microsite Masthead's wordmark
 * imports it from this component's subpath — one copy, no fork.
 *
